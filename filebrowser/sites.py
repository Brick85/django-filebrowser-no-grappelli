...
class FileBrowserSite(object):
    ...
    def createdir(self, request):
        ...
        return render(request, 'filebrowser/createdir.html', admin_context({
            'form': form,
            'query': query,
    ...
    def upload(self, request):
        ...
        return render(request, 'filebrowser/upload.html', admin_context({
            'query': query,
    ...
    def version(self, request):
        ...
        return render(request, 'filebrowser/version.html', admin_context({
            'fileobject': fileobject,
            'query': query,
            'settings_var': get_settings_var(directory=self.directory),
            'filebrowser_site': self
